...
/// OpenGL function pointers. / Helper libraries are often used for this
/// purpose! Here we are using our own minimal custom loader based on gl3w. / In
/// the rest of your app/engine, you can use another loader of your choice
/// (gl3w, glew, glad, glbinding, glext, glLoadGen, etc.). / If you happen to be
/// developing a new feature for this backend (imgui_impl_opengl3.cpp): / - You
/// may need to regenerate imgui_impl_opengl3_loader.h to add new symbols. See
/// https://github.com/dearimgui/gl3w_stripped / - You can temporarily use an
/// unstripped version. See https://github.com/dearimgui/gl3w_stripped/releases
//// Changes to this backend using new APIs should be accompanied by a
/// regenerated stripped loader version.
// #define IMGL3W_IMPL
...
bool ImGui_ImplOpenGL3_Init(const char* glsl_version) {
    ...
    if (const char* vendor = (const char*)glGetString(GL_VENDOR))
        if (strncmp(vendor, "Intel", 5) == 0)
            ...
            // '%s'\nGL_RENDERER = '%s'\n", major, minor, (const
            // char*)glGetString(GL_VENDOR), (const
            // char*)glGetString(GL_RENDERER)); // [DEBUG]
#else
...
void ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data) {
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++) {
        ...
        // led to accumulating leaks when using multi-viewports, so we started
        // using orphaning + glBufferSubData(). (See
