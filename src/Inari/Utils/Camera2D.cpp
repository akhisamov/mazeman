...
void Camera2D::setPositionX(float value) {
    setPosition(glm::vec2(value, m_position.y));
}
void Camera2D::setPositionY(float value) {
    setPosition(glm::vec2(m_position.x, value));
}
...
void Camera2D::moveX(float value) {
    move(glm::vec2(value, 0));
}
void Camera2D::moveY(float value) {
    move(glm::vec2(0, value));
}
